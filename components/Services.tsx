...
const Services: React.FC = () => {
  ...
  return (
    <section className="py-24 pt-32 bg-brand-sand relative overflow-hidden min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-24">
          ...
          <h2 className="mt-3 font-serif text-4xl md:text-5xl font-bold text-brand-dark leading-tight">
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {service.features.map((feature, i) => (
                    <li key={i} className="flex items-center gap-3 text-brand-dark font-medium">
                      <div className="w-1.5 h-1.5 bg-brand-sunset rounded-full"></div>
                      {feature}
                    </li>
                  ))}
                </ul>
