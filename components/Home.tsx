...
const Home: React.FC = () => {
  usePageSEO(
    ...
    "Votre chauffeur privé et guide touristique au Sénégal. Découvrez Dakar, Gorée, le Lac Rose et Saly en toute liberté. Transport confortable, circuits sur mesure et immersion locale garantie."
  );
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="w-full lg:w-1/2 relative">
              ...
              <img 
                src="https://images.unsplash.com/photo-1512958789358-4dac0f3d56ef?q=80&w=2070&auto=format&fit=crop" 
                alt="Route au Sénégal" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
             ...
             <Link to="/destinations" className="group relative h-80 rounded-2xl overflow-hidden cursor-pointer shadow-lg">
                <img src="https://images.unsplash.com/photo-1623853876008-052601724031?q=80&w=1974&auto=format&fit=crop" alt="Lac Rose" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent p-6 flex flex-col justify-end">
                  <h3 className="text-white font-serif text-2xl font-bold">Lac Rose</h3>
                  <p className="text-gray-300 text-sm mt-2 opacity-0 group-hover:opacity-100 transition-opacity transform translate-y-4 group-hover:translate-y-0 duration-300">Une merveille naturelle unique au monde.</p>
                </div>
             </Link>

             {/* Card 2 */}
             <Link to="/destinations" className="group relative h-80 rounded-2xl overflow-hidden cursor-pointer shadow-lg">
                <img src="https://images.unsplash.com/photo-1596489852237-773a4d048493?q=80&w=2070&auto=format&fit=crop" alt="Gorée" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent p-6 flex flex-col justify-end">
             ...
             {/* Card 3 */}
             <Link to="/destinations" className="group relative h-80 rounded-2xl overflow-hidden cursor-pointer shadow-lg">
                <img src="https://images.unsplash.com/photo-1516426122078-c23e76319801?q=80&w=2068&auto=format&fit=crop" alt="Bandia" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent p-6 flex flex-col justify-end">
